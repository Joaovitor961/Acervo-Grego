  ...
  return (
    <div>
      ...
      <div className="row">
        ...
        {filtered.map(h => (
          <div key={`${h.id}-${h.name}`} className="col-12 col-md-6 col-lg-4 mb-3 card-animated">
            <div className="card h-100">
              ...
              <div className="card-body d-flex flex-column">
                ...
                <div className="mt-2">
                  <Link to={`/heroes/${encodeURIComponent(String(h.id))}`} className="btn btn-primary btn-sm">Ver Detalhes</Link>
                </div>
              </div>
            </div>
          </div>
